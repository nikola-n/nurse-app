                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <x-input.text wire:model="reading.diastolic_pressure" type="number" name="diastolic_pressure" id="diastolic_pressure" :error="$errors->first('diastolic_pressure')" leadingAddOn="mm Hg" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <x-input.text wire:model="reading.systolic_pressure" type="number" name="systolic_pressure" id="systolic_pressure" :error="$errors->first('systolic_pressure')" leadingAddOn="mm Hg" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <x-input.select wire:model="reading.status" id="status" name="status">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <x-input.date wire:model="reading.measured_at" name="measured_at" id="measured_at" :error="$errors->first('measured_at')" />
                        </div>
                    </div>
