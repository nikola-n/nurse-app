                ...
                <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <x-input.text wire:model="patient.name" type="text" name="name" id="name" placeholder="Enter Patient's Name" :error="$errors->first('patient.name')"/>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <x-input.text wire:model="patient.email" type="email" name="email" id="email" placeholder="you@example.com" :error="$errors->first('patient.email')" />
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <x-input.text wire:model="patient.phone" type="text" name="phone" id="phone" placeholder="+38970264995" :error="$errors->first('patient.phone')" />
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <x-input.select wire:model="patient.gender" id="gender" name="gender">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div class="col-span-3 sm:col-span-2">
                            ...
                            <x-input.date wire:model="patient.date_of_birth" name="date_of_birth" id="date_of_birth" />
                        </div>
                    </div>
